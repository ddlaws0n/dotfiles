Always review and update the existing Markdown documentation in the docs/ directory. If no documentation or directory exists, create one. When updating, ensure that the documentation remains concise, relevant, and structured for ease of understanding.
...
- Document reference file locations as needed in the docs. Always update 'docs/index-md with the document file if it is not existing in the index.
